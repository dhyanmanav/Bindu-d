  ...
  const projects = [
    {
      ...
      date: '2024 – 2025',
      duration: '3:10',
      img: '/images.jpg', // works
      features: [
        '85%+ accuracy using EfficientNet model',
        'Grad-CAM explainability for prediction insights',
        'Real-time camera and image upload support',
        'Weather-based skincare recommendations',
      ],
      plays: '1.1M',
      liveLink: 'https://bindu-kushi.streamlit.app/',
      githubLink: 'https://github.com/bindu-draj'
    },
    {
      ...
      date: '2024',
      duration: '2:40',
      img: '/images.png', // works
      features: [
        'Clean Spotify-inspired UI and layouts',
        'Adaptive grid design with smooth animations',
        'Mobile-first responsive interface',
        'Showcases skills, contact, and project modules',
      ],
      plays: '820K',
      liveLink: 'https://bindu-raj.netlify.app/',
      githubLink: 'https://github.com/bindu-draj'
    }
  ];
